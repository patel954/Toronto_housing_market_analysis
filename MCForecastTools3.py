...
class MCSimulation:
    ...
    def plot_distribution(self, location="Toronto C01"):
        """
        ...
        plot_title = f"Location: {location}. Distribution of Final Cumuluative Returns Across All {self.nSim} Simulations"
